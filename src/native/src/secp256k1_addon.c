...
napi_status create_secp256k1_addon(napi_env env, napi_value base)
{
    ...
    napi_property_descriptor properties[] = {
        DECLARE_NAPI_METHOD("privateKeyVerify", secp256k1_addon_private_key_verify),
        DECLARE_NAPI_METHOD("publicKeyCreate", secp256k1_addon_public_key_create),
        DECLARE_NAPI_METHOD("sign", secp256k1_addon_sign),
        DECLARE_NAPI_METHOD("verify", secp256k1_addon_verify)
    };
